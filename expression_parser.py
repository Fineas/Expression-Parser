                ...
                if payload[counter-1] in log_con: # this means variable is on right side
                    ...
                    if payload[counter-1] == '(':
                        if payload[counter+1] != '!':
                            ...
                            print '[*] Invalid Expression' # we cannot have syntax: A!
                            return
                    else:
                        print '[*] Invalid Expression'
                        return
                ...
                if chr == '!':
                    if payload[counter-1] == '(':
                        if payload[counter+1] == '(' or payload[counter+1] in constants:
                            ...
                            print '[*] Invalid Expression' # we cannot have something different but ( or CONST after !
                            return
                    else:
                        print '[*] Invalid Expression' # we cannot have something different but ( before !
                        return
                else:
                    if payload[counter-1] in constants and payload[counter+1] in constants: # we can have A # A
                        ...
                        print '[*] Invalid Expression' # any other combination is wrong
                        return
